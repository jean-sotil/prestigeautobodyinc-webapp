...
export default function Footer({ className = '' }: FooterProps) {
  ...
  return (
    <footer className={`bg-[#121212] ${className}`}>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <address className="not-italic flex flex-col gap-1 text-xs text-[#b3b3b3]">
              ...
              <ul className="flex flex-col gap-2">
                {quickLinks.map((link) => (
                  <li key={`${link.href}-${link.label}`}>
                    <Link
                      href={link.href as '/'}
                      className="text-xs text-[#b3b3b3] hover:text-[#c62828] transition-colors"
                    >
                      {link.label}
                    </Link>
                  </li>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="w-full h-[120px] rounded-lg overflow-hidden bg-[#2e2e2e] border border-[#333]">
              <iframe
                src={mapEmbedUrl}
