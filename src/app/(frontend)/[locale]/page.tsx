  ...
  return (
    <div className="font-sans min-h-screen">
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 lg:px-16 py-16 flex items-center">
          <div className="flex flex-col gap-4 w-full lg:w-135 shrink-0">
            ...
            <div className="flex flex-col gap-4 motion-safe:animate-slide-in-left motion-safe:delay-500">
              ...
              <Link href="/gallery">
                <span className="text-xs hover:underline font-semibold text-white/80 group-hover:text-white/90 transition-colors">
        ...
        <div
          className="absolute top-2 left-1/2 -translate-x-1/2 sm:top-6 lg:top-8 z-10 pointer-events-none motion-safe:animate-fade-in-up"
